		...
		<div id="poststuff">
			<div id="post-body" class="metabox-holder columns-2">
				<table class="form-table">
					<tr class="form-field">
						<th scope="row">
							<label for="stats_excel">Room Number :</label>
						</th>
						<td>
							<input type="text" name="room_number" value="<?php echo $input->room_number ?>" required />
						</td>
					</tr>
					<tr class="form-field">
						<th scope="row">
					...
					<tr class="form-field">
						...
						<td>
							<textarea name="description" id="room_description" rows="5"><?php echo $input->description ?></textarea>
						</td>
					</tr>
					<tr class="form-field">
						<th scope="row">
